...
/***/ function(module, exports, __webpack_require__) {
	...
	var itemEvents = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getStarted = function getStarted(event) {
	  event.preventDefault();
	  ui.proceedToLogin(event);
	};

	var getSignedUp = function getSignedUp() {
	  event.preventDefault();
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpdata).done(function (data, textStatus, jqXHR) {
	    api.autoLogIn(data, textStatus, jqXHR, signUpdata).done(ui.signUpSuccess).fail(ui.failure);
	  }).fail(ui.failure);
	};
	...
	var getChangePassword = function getChangePassword(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var proceedToLogin = function proceedToLogin() {
	  $('.intro-wrapper').addClass('hide');
	  $('.login-wrapper').removeClass('hide');
	};

	var proceedToSignUp = function proceedToSignUp() {
	...
	var proceedToChangePw = function proceedToChangePw() {
	...
	module.exports = {
	  ...
	  proceedToChangePw: proceedToChangePw,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAList = function getAList(data) {
	  event.preventDefault();
	  api.getOneList(data).done(ui.showUpdatedList).fail(ui.failure);
	};
	...
	var onNewList = function onNewList(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createNewList(data).done(ui.newListSuccess).done(ui.clearMyLists).done(getMyLists).fail(ui.failure);
	};
	...
	var getUpdateList = function getUpdateList(event) {
	...
	var onUpdateListAllView = function onUpdateListAllView(event) {
	  event.preventDefault();
	  var updateListId = $('.list-name-wrapper').data('id');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showNewListTemplate = __webpack_require__(33);
	//const deleteListTemplate = require ('../templates/delete-list.handlebars');


	// for getting all lists

	var myListsSuccess = function myListsSuccess(data) {
	...
	var proceedToCreateList = function proceedToCreateList() {
	  $('#new-list-form').removeClass('hide');
	};

	var newListSuccess = function newListSuccess() {
	  //  console.log('new list data is', data);
	  //  app.user = data.user;
	...
	// for updating a list title
	var proceedToUpdateList = function proceedToUpdateList() {
	...
	var showUpdatedList = function showUpdatedList(data) {
	...
	var clearMyLists = function clearMyLists() {
	  event.preventDefault();
	...
	module.exports = {
	  proceedToCreateList: proceedToCreateList,
	  myListsSuccess: myListsSuccess,
	  newListSuccess: newListSuccess,
	  deleteListSuccess: deleteListSuccess,
	  failure: failure,
	  proceedToUpdateList: proceedToUpdateList,
	  updateListSuccess: updateListSuccess,
	  showUpdatedList: showUpdatedList,
	  clearMyLists: clearMyLists
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"list-name-wrapper\" data-id="
	    ...
	    + ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"add-new-item","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<!-- <div class=\"add-list-wrapper\" data-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "> -->\n<h1>My Lists</h1>\n<!-- <button id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " class=\"btn add-list-all-view\">ADD</button> -->\n<!-- </div> -->\n\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2>"
	    ...
	    + " class=\"btn add-item-all-view\">ADD</button> -->\n<button id="
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn edit-list-all-view\">EDIT</button>\n<button id="
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn delete-list\">DELETE</button></h2>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <li>"
	    ...
	    + "</li>\n    <li> "
	    + alias4(((helper = (helper = helpers.due_time || (depth0 != null ? depth0.due_time : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"due_time","hash":{},"data":data}) : helper)))
	    + "</li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "<div class=\"item-wrapper\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n  <ul>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.items : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    <!-- <li><button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn edit-item\">EDIT</button></li>\n    <li><button id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn delete-item\">DELETE</button></li> -->\n  </ul>\n\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"list-name-wrapper\" data-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + ">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"lists-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</div>\n\n  <!-- // were nested inside this object now and so should be\n  able to do "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2>"
	    ...
	    + "\n<button id="
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn add-item\">ADD</button>\n<button id="
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn edit-list\">EDIT</button>\n<button id="
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn delete-list\">DELETE</button></h2>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNewItemForm = function getNewItemForm(event) {
	...
	var onAddItem = function onAddItem(event) {
	  ...
	  event.preventDefault();
	  var listId = $('.list-name-wrapper').data('id');
	  $("#listIdItemAdd").val(listId);
	  var data = getFormFields(event.target);
	  api.createNewItem(data)
	  //  .done(itemsUi.clearMyLists)
	  .done(listApi.getOneList(data)).done(ui.newItemSuccess).fail(ui.failure);
	};

	// adds an item to a list in the all list view

	var onAddItemAllView = function onAddItemAllView(event) {
	  //console.log('onAddItem is running');
	  event.preventDefault();
	  ...
	  api.createNewItem(data).done(listUi.clearMyLists).done(listEvents.getMyLists(data)).done(ui.newItemSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showNewItemTemplate = __webpack_require__(32);

	var proceedToItemForm = function proceedToItemForm() {
	...
	module.exports = {
	  proceedToItemForm: proceedToItemForm,
