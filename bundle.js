...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewList = function onNewList(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createNewList(data).done(ui.newListSuccess).fail(ui.failure);
	};
	...
	var onUpdateList = function onUpdateList(event) {
	  ...
	  api.updateListTitle(data).done(getAList(data)).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showNewListTemplate = __webpack_require__(31);
	...
	var newListSuccess = function newListSuccess(data) {
	  //  console.log('new list data is', data);
	  //  app.user = data.user;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"list-name-wrapper\" data-id="
	    ...
	    + "\n      </td>\n    <td>\n        "
	    + alias4(alias5((depth0 != null ? depth0.task : depth0), depth0))
	    + "\n    </td>\n    <td>\n      "
	    + alias4(alias5((depth0 != null ? depth0.priority : depth0), depth0))
	    + "\n    </td>\n    <td>\n      "
	    + alias4(alias5((depth0 != null ? depth0.due : depth0), depth0))
	    + "\n    </td>\n  </tr>\n  </tbody>\n</table>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h1>My Lists:</h1>\n\n"
